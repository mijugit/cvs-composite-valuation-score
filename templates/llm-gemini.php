...
/**
 * LLM_Gemini_Wallet — read-only view.
 *
 * @var array<string, mixed>              $state          llm_gemini_state row (cash, initial_capital, updated_at)
 ...
 * @var array<string, mixed>              $walletConfig   config/llm-gemini-wallet.php
...
<div style="margin-bottom:1.5rem;">
    ...
    <p style="color:var(--c-muted);font-size:var(--text-sm);margin:0;">
        ...
        internetowym zamiast dzielenia infrastruktury z Claude.
    </p>
</div>
