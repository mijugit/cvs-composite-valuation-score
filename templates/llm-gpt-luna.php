...
/**
 * LLM_GPT_Luna_Wallet — read-only view.
 *
 * @var array<string, mixed>              $state          llm_gpt_luna_state row (cash, initial_capital, updated_at)
 ...
 * @var array<string, mixed>              $walletConfig   config/llm-gpt-luna-wallet.php
...
// templates/llm-gemini.php's copy.
...
<div style="margin-bottom:1.5rem;">
    ...
    <p style="color:var(--c-muted);font-size:var(--text-sm);margin:0;">
        ...
        natywnym wyszukiwaniem internetowym zamiast dzielenia infrastruktury z Claude.
    </p>
</div>
