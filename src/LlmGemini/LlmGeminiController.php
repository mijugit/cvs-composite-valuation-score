 ...
 * live-repricing shape, same legend history, but passes all three wallets'
 * cycle repositories into WalletNavChartService for a full three-way NAV
 * comparison (Bazowy + Free + Gemini + benchmarks) instead of just two.
 */
