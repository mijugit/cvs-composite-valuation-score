...
class LlmFreeDecisionServiceTest extends TestCase
{
    private PDO                    $db;
    ...
    protected function setUp(): void
    {
        ...
        $this->portfolioState = ['cash' => 10000.0, 'initial_capital' => 10000.0, 'updated_at' => '2026-08-07 21:30:00'];
        $this->holdings       = [];
        $this->screenerRows   = [
    ...
    private function makeService(FakeTransport $transport): LlmFreeDecisionService
    {
        $client = ClaudeClientFactory::fromConfig($this->aiConfig, $transport);
        return new LlmFreeDecisionService($this->cycleRepo, $this->aiConfig, $this->walletConfig, $client);
    }
    ...
    // --- System prompt content (reflection — buildSystemPrompt is private) ---
