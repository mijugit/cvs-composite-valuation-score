...
class LlmGeminiDecisionServiceTest extends TestCase
{
    private PDO                      $db;
    ...
    private function makeService(FakeTransport $transport): LlmGeminiDecisionService
    {
        $client = GeminiClientFactory::fromConfig($this->geminiConfig, $transport);
        return new LlmGeminiDecisionService($this->cycleRepo, $this->geminiConfig, $this->walletConfig, $client);
    }
