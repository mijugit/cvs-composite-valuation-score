...
class LlmGptLunaCycleRepositoryTest extends TestCase
{
    private PDO                      $db;
    private LlmGptLunaCycleRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new LlmGptLunaCycleRepository($this->db);
    }

    /** @return array<string,mixed> */
    private function fetch(string $date): array
    {
        $stmt = $this->db->prepare('SELECT * FROM llm_gpt_luna_cycle WHERE cycle_date = ?');
        $stmt->execute([$date]);
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count) VALUES ('2026-08-19', 'completed', 1)");
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count) VALUES ('2026-08-19', 'started', 1)");
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count, finished_at) VALUES ('2026-08-19', 'llm_failed', 1, CURRENT_TIMESTAMP)");
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count) VALUES ('2026-08-19', 'failed', 3)");
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count) VALUES ('2026-08-19', 'failed', 2)");
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count, portfolio_value_usd) VALUES ('2026-08-19', 'completed', 1, 10123.45)");
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count, portfolio_value_usd) VALUES ('2026-08-17', 'completed', 1, 10000.00)");
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, attempt_count) VALUES ('2026-08-18', 'llm_failed', 1)");
