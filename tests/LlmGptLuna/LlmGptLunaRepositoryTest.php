 ...
 */
class LlmGptLunaRepositoryTest extends TestCase
{
    private PDO                 $db;
    private LlmGptLunaRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new LlmGptLunaRepository($this->db);
    }
    ...
    {
        $this->db->exec("INSERT INTO llm_gpt_luna_cycle (cycle_date, status, started_at, legend)
